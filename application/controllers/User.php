...
class User extends CI_Controller{
  ...
  public function logout(){
    ...
    $this->session->unset_userdata('kol_user_id');
    ...
    if($kol_user_id == '' || $kol_company_id == ''){
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        if($login == null){
          ...
          // echo 'null not';
          $this->session->set_userdata('kol_user_id', $login[0]['user_id']);
...
/**************************      Company Information      ********************************/
  ...
  public function company_list(){
    ...
    $data['company_list'] = $this->Master_Model->get_list($kol_company_id,'company_id','ASC','company');
    $data['page'] = 'Company';
    $this->load->view('Admin/Include/head', $data);
    $this->load->view('Admin/Include/navbar', $data);
...
/*******************************    Branch Information      ****************************/
  ...
  public function branch(){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $save_data['branch_addedby'] = $kol_user_id;
    ...
    $data['branch_list'] = $this->Master_Model->get_list_by_id3($kol_company_id,'','','','','','','branch_id','ASC','rest_branch');
    $data['page'] = 'Branch';
    $this->load->view('Admin/Include/head', $data);
    $this->load->view('Admin/Include/navbar', $data);
  ...
  public function edit_branch($branch_id){
    ...
    if ($this->form_validation->run() != FALSE) {
      ...
      $update_data['branch_addedby'] = $kol_user_id;
