...
/*****************************************************************************************/
  ...
  // Edit Brand...
  public function edit_blog($brand_id){
    $kol_user_id = $this->session->userdata('kol_user_id');
    $kol_company_id = $this->session->userdata('kol_company_id');
    $kol_role_id = $this->session->userdata('kol_role_id');
    if($kol_user_id == '' && $kol_company_id == ''){ header('location:'.base_url().'User'); }
    ...
    $this->load->view('Admin/Include/head');
    $this->load->view('Admin/Include/navbar');
    $this->load->view('Admin/Master/blog');
    $this->load->view('Admin/Include/footer');
  }
  ...
  public function edit_coupon($coupon_id){
    ...
    $this->form_validation->set_rules('coupon_name', 'coupon title', 'trim|required');
    
    
    $this->load->view('Admin/Include/head');
    $this->load->view('Admin/Include/navbar');
    $this->load->view('Admin/Master/coupon');
    $this->load->view('Admin/Include/footer');
  }
  ...
  public function delete_coupon($coupon_id){
    ...
    $kol_role_id = $this->session->userdata('kol_role_id');
    if($kol_user_id == '' && $kol_company_id == ''){ header('location:'.base_url().'User'); }
    $this->Master_Model->delete_info('coupon_id', $coupon_id, 'rest_coupon');
    $this->session->set_flashdata('delete_success','success');
...
/********************************* Role Information ***********************************/
  ...
  public function edit_product($product_id){
    ...
    $this->form_validation->set_rules('product_name', 'role title', 'trim|required');
    
    
    $this->load->view('Admin/Include/head');
    $this->load->view('Admin/Include/navbar');
    $this->load->view('Admin/Master/product');
    $this->load->view('Admin/Include/footer');
  }
  ...
  public function delete_product($product_id){
    ...
    $kol_role_id = $this->session->userdata('kol_role_id');
    if($kol_user_id == '' && $kol_company_id == ''){ header('location:'.base_url().'User'); }
    $this->Master_Model->delete_info('product_id', $role_id, 'rest_role');
    $this->session->set_flashdata('delete_success','success');
