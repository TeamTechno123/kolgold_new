                  ...
                  <form class="input_form m-0" id="form_action" role="form" action="" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="row p-4">
                      ...
                      <div class="form-group col-md-12 ">
                        ...
                        <input type="text" class="form-control form-control-sm" name="blog_name" id="blog_name" value="<?php if(isset($brand_info)){ echo $brand_info['blog_name']; } ?>" placeholder="Enter Title" required>
                      </div>
                   ...
                   <div class="form-group col-md-6">
                      ...
                      <input type="file" class="form-control form-control-sm" name="blog_logo" id="blog_logo" >
                    </div>
