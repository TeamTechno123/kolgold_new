          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="product">
                ...
                <div class="row">
                  <div class="col-4">
                    <img class="p-0 mb-3" src="<?php echo base_url(); ?>assets/images/website/product2.png" width="100%">
                  </div>
                  <div class="col-8">
                ...
                <div class="col-md-4 mb-3">
                   <div class="dropdown ">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="#">Sort By Avg Rating</a>
                        <a class="dropdown-item" href="#">Sort By Letest</a>
                        <a class="dropdown-item" href="#">Sort By Low To High</a>
                        <a class="dropdown-item" href="#">Sort By High To Law</a>
                      </div>
                    </div>
                </div>
