...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>assets/images/website/favicon-16x16.png">
    <meta name="description" content="kolgold-Pure Non Chemical Export Quality Jaggery">
    <!-- Bootstrap CSS -->
  ...
  <body>
    <section class="top-nav">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
              <p class="marquee"> <span>Due to COVID-19, deliveries are facing transport restrictions. All courier services are running very slow. Minimum time for delivery is 10-17 days post handover. Please take note that NO urgent deliveries can be made at this point. Kindly consider this before ordering. </span>  </p>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="hover-show">
                  <p class="f-14"><?php echo $list->product_descr; ?></p>
                  <div class="row">
                    <div class="col-2">
          ...
          <div class="row">
            ...
            <div class="owl-carousel owl-theme owl-four">
                <div class="item">
                    ...
                    <div class="card-body">
                      <h5 class="card-title text-center">Vivekanand</h5>
                      <p class="text-center">I was amazed to see the range of Jaggery at Kolgold, a brand you can trust !  </p>
                ...
                <div class="item">
                    ...
                    <div class="card-body">
                      ...
                      <p class="text-center">OK, so I dared to try something new. Well, once I figured out to use it, it was marvelous. (You shave it...)  </p>
                     <!--  <p class="text-center"> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="fas fa-star bg-grey"></i> </p> -->
                    </div>
                  </div>
                </div>
                <div class="item">
                    ...
                    <img class="card-img-top" src="<?php echo base_url(); ?>assets/images/website/stevan.png " alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title text-center">Abhijeet</h5>
                      <p class="text-center">Good quality gur/jaggery. It was fresh and the flavor was good and no bad taste.   </p>
                     <!--  <p class="text-center"> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="fas fa-star bg-grey"></i> </p> -->
                    </div>
                  </div>
                </div>
               <div class="item">
                    ...
                    <img class="card-img-top" src="<?php echo base_url(); ?>assets/images/website/stevan.png " alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title text-center">Sagar</h5>
                      <p class="text-center">Good healthy product, you can add into anything as a alternative to sugar.</p>
                      <!-- <p class="text-center"> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="fas fa-star bg-grey"></i> </p> -->
                    </div>
                  </div>
                </div>
               <div class="item">
                    ...
                    <img class="card-img-top" src="<?php echo base_url(); ?>assets/images/website/stevan.png " alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title text-center">Rafiq</h5>
                      <p class="text-center">Delicious flavorful sugar that not only tastes good but is also used in India as medicine. </p>
                      <!-- <p class="text-center"> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="far fa-star"></i> <i class="fas fa-star bg-grey"></i> </p> -->
                    </div>
                  </div>
                </div>
