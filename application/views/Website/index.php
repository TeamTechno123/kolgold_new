  ...
  <section class="home-nav">   
                ...
                <div class="item">
                  <div class="main-slide">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-12">
                          <img src="<?php echo base_url(); ?>assets/images/website/gul.png" width="100%">
                      </div>                      
                    </div>
                  </div>                     
                </div>  
              ...
              <div class="row">
                ...
                <div class="item">
                  <div class="main-second">
                     <div class="row">
                       <div class="col-md-6 col-12">
                          <img class="left-img" src="<?php echo base_url(); ?>assets/images/website/panhala.png" width="100%">
                      </div>  
                      <div class="col-md-6 col-12">
                          <h1>Panhala fort </h1>
    ...
    <section class="category-main">
      ...
      <div class="owl-carousel owl-theme owl-three">
                <div class="item">
                    <div class="card">
                        <img class="card-img-top p-30" src="<?php echo base_url(); ?>assets/images/website/product1.png " alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title text-center">Kolhapur Chappal</h5>                 
                        </div>
                      </div>   
                </div>
                <div class="item">
                    <div class="card">
                        <img class="card-img-top p-30" src="<?php echo base_url(); ?>assets/images/website/product2.png " alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title text-center">Kolhapur Gul</h5>                 
                        </div>
                      </div>    
                </div>
                <div class="item">
                    <div class="card">
                        <img class="card-img-top p-30" src="<?php echo base_url(); ?>assets/images/website/product4.png " alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title text-center">Kolhapur Masala</h5>                 
                        </div>
                      </div>    
                </div>
                <div class="item">
                   <div class="card">
                        <img class="card-img-top p-30" src="<?php echo base_url(); ?>assets/images/website/product3.png " alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title text-center">Kolhapur Handcrafted</h5>                 
                        </div>
                      </div>  
                </div>
                <div class="item">
      ...
      <section class="footer">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-3 d-none d-sm-block">
                <div class="row">
              ...
              <div class="col-md-3 no-border-right col-3 d-none d-sm-block">
                <div class="row">
            ...
            <div class="col-md-9">
              <div class="row">
                <div class="col-md-3 col-6">
                    ...
                    <ul>
                      ...
                      <li><a href="<?php echo base_url(); ?>Payment-Methode">Payment Methode</a></li>
             ...
             <div class="col-md-3 col-6">
                     ...
                     <ul>
                      ...
                      <li><a href="<?php echo base_url(); ?>">Discount</a></li>
                      <li><a href="<?php echo base_url(); ?>website/return">Return</a></li>
                      <li><a href="<?php echo base_url(); ?>Register">Sign Up</a></li>
                      <li><a href="<?php echo base_url(); ?>Register">Sign In</a></li>
                      <li><a href="<?php echo base_url(); ?>">Order History</a></li>
                      <li><a href="<?php echo base_url(); ?>website/order_tracking">Order Traking</a></li>
                     </ul>
                </div>
